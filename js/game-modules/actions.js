...
import { addMolotovCocktail, addShotgunParticle, setScreenFlash } from './state-manager.js';
...
export function startFireballRoll(state) {
    ...
    export function startShotgunBlast(state) {
        ...
        export function startMolotovCocktail(state) {
            ...
            if (!consumeEnergy(state, 'molotovCocktail')) return;
            ...
            playAnimationSound('molatov-cocktail-hurl');
                ...
                let targetObstacle = state.currentObstacle || state.ignitedObstacles[0] || state.vanishingObstacles[0];
                ...
                // If no obstacle, create a dummy target 300px ahead
                            ...
                            if (!targetObstacle) {
                                ...
                                console.log("-> Molotov Cocktail: No obstacle found, creating dummy target.");
                                ...
                                const targetY = GROUND_Y - targetObstacle.x * Math.tan(state.raceSegments[state.currentSegmentIndex].angleRad) + OBSTACLE_EMOJI_Y_OFFSET - (OBSTACLE_HEIGHT / 2); // Aim for center of obstacle
                                ...
                                const velocityX = 7; // A faster, constant forward speed
                                ...
                                // Calculate required initial vertical velocity to hit targetY in that time
                            ...
                            console.log("-> Molotov Cocktail: Launched!");
